...
namespace Eliyas5044\LaravelVisualInstaller\Middleware;

use Closure;
use Eliyas5044\LaravelVisualInstaller\Helpers\MigrationsHelper;
        ...
        switch ($updateEnabled) {
            case true:
                ...
                if (!$canInstall->alreadyInstalled()) {
                    return redirect()->route('LaravelVisualInstaller::welcome');
                }
