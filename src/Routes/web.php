...
Route::group(['prefix' => 'install', 'as' => 'LaravelVisualInstaller::', 'namespace' => 'Eliyas5044\LaravelVisualInstaller\Controllers', 'middleware' => ['web', 'install']], function () {
    Route::get('/', [
        'as' => 'welcome',
    ...
    Route::get('storage-link', [
        'as' => 'storage-link',
        'uses' => 'StorageLinkController@storageLink'
    ]);

    Route::post('generate-storage-link', [
        'as' => 'generate-storage-link',
        'uses' => 'StorageLinkController@makeLinks'
    ]);
...
Route::group(['prefix' => 'update', 'as' => 'LaravelUpdater::', 'namespace' => 'Eliyas5044\LaravelVisualInstaller\Controllers', 'middleware' => 'web'], function () {
